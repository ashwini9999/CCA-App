...
import {
  ...
  Text,       // Handles navigation between screens
    ...
    renderScrollView = pages => {
      return (
        <Swiper 
          ...
          prevButton 
          nextButton={
              <Text style={{ color:'white',paddingTop:550,paddingRight:20}}>Next</Text>
            }
            loop={false}
        >
            {pages.map((page, i) =>
              ...
              <View style={[styles.fullScreen, styles.slide]} key={i}>
                {page}
                  <Button title="Start Now" onPress={() => this.props.navigation.navigate('Login')} />
              </View>
            )}
        </Swiper>
      );
      ...
      return (
        <View pointerEvents="box-none" style={[styles.buttonWrapper, styles.fullScreen]}>
          {lastScreen
            ...
            ? <Button text="Start Now" onPress={() => this.props.navigation.navigate('Login')} />
